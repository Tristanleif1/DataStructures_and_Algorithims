...
class Solution:
    def pathSum(self, root: Optional[TreeNode], targetSum: int) -> int:
       ...
       #The idea is to maintain prefix sums while doing dfs from root to leaf. If currentSum-prefixSum=
       #targetSum, then we've found a path that has a value of target. If we encountered prefixSum n times, 
       #then we've found n such paths
